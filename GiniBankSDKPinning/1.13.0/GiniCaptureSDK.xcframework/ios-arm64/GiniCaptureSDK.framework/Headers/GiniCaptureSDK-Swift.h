...
#ifndef GINICAPTURESDK_SWIFT_H
#define GINICAPTURESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GiniCaptureSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// note:
/// Screen API only.
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK16AnalysisDelegate_")
...
/// In case that the <code>GiniCaptureDocument</code> analysed is an image it will display a no results screen
...
typedef SWIFT_ENUM(NSInteger, AnalysisError, open) {
...
static NSString * _Nonnull const AnalysisErrorDomain = @"GiniCaptureSDK.AnalysisError";

@class UIImage;
@class Extraction;
@class Candidate;

SWIFT_CLASS("_TtC14GiniCaptureSDK14AnalysisResult")
...
/// <a href="https://pay-api.gini.net/documentation/#specific-extractions">here</a>,
...
@property (nonatomic, readonly, copy) NSArray<NSArray<Extraction *> *> * _Nullable lineItems;
...
/// note:
/// Component API only.
SWIFT_CLASS("_TtC14GiniCaptureSDK22AnalysisViewController")
...
- (nonnull instancetype)initWithDocument:(id <GiniCaptureDocument> _Nonnull)document giniConfiguration:(GiniConfiguration * _Nonnull)giniConfiguration OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// A view controller instance giving the user a nice user interface while waiting for the analysis results.
- (nonnull instancetype)initWithDocument:(id <GiniCaptureDocument> _Nonnull)document;
...
typedef SWIFT_ENUM(NSInteger, CameraError, open) {
...
static NSString * _Nonnull const CameraErrorDomain = @"GiniCaptureSDK.CameraError";

@protocol CameraViewControllerDelegate;
@protocol UIViewControllerTransitionCoordinator;

SWIFT_CLASS("_TtC14GiniCaptureSDK20CameraViewController")
...
- (nonnull instancetype)initWithGiniConfiguration:(GiniConfiguration * _Nonnull)giniConfiguration OBJC_DESIGNATED_INITIALIZER;
/// Returns an object initialized from data in a given unarchiver.
/// warning:
/// Not implemented.
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface CameraViewController (SWIFT_EXTENSION(GiniCaptureSDK))
...
/// note:
/// Component API only.
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK28CameraViewControllerDelegate_")
@protocol CameraViewControllerDelegate
...
///
- (void)camera:(CameraViewController * _Nonnull)viewController didCapture:(id <GiniCaptureDocument> _Nonnull)document;
...
SWIFT_CLASS("_TtC14GiniCaptureSDK29CustomDocumentValidationError")
...
SWIFT_CLASS("_TtC14GiniCaptureSDK30CustomDocumentValidationResult")
@interface CustomDocumentValidationResult : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, DocumentImportMethod, open) {
  DocumentImportMethodOpenWith = 0,
  DocumentImportMethodPicker = 1,
};


SWIFT_CLASS("_TtC14GiniCaptureSDK25DocumentPickerCoordinator")
...
@interface DocumentPickerCoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <UIDocumentPickerDelegate>
...
@interface DocumentPickerCoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <UIDropInteractionDelegate>
...
///
/// \endcode
typedef SWIFT_ENUM(NSInteger, DocumentPickerType, open) {
/// Gallery picker
...
typedef SWIFT_ENUM(NSInteger, DocumentValidationError, open) {
...
static NSString * _Nonnull const DocumentValidationErrorDomain = @"GiniCaptureSDK.DocumentValidationError";

/// Errors thrown on the file picker
typedef SWIFT_ENUM(NSInteger, FilePickerError, open) {
...
static NSString * _Nonnull const FilePickerErrorDomain = @"GiniCaptureSDK.FilePickerError";


SWIFT_CLASS("_TtC14GiniCaptureSDK17GiniBarButtonItem")
@interface GiniBarButtonItem : UIBarButtonItem
...
/// The Gini Capture SDK can be integrated in two ways, either by using the <em>Screen API</em> or
...
SWIFT_CLASS("_TtC14GiniCaptureSDK11GiniCapture")
@interface GiniCapture : NSObject
...
/// returns:
/// A presentable view controller.
+ (UIViewController * _Nonnull)viewControllerWithDelegate:(id <GiniCaptureDelegate> _Nonnull)delegate withConfiguration:(GiniConfiguration * _Nonnull)configuration importedDocument:(id <GiniCaptureDocument> _Nullable)importedDocument SWIFT_WARN_UNUSED_RESULT;
...
/// Validates a <code>GiniCaptureDocument</code> with a given <code>GiniConfiguration</code>.
///
/// throws:
/// <code>DocumentValidationError</code> if there was an error during the validation.
+ (BOOL)validate:(id <GiniCaptureDocument> _Nonnull)document withConfig:(GiniConfiguration * _Nonnull)giniConfiguration error:(NSError * _Nullable * _Nullable)error;
...
/// note:
/// Screen API only.
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK19GiniCaptureDelegate_")
@protocol GiniCaptureDelegate
/// Called when the user has taken a picture or imported a file (image or PDF) from camera roll or document explorer
/// \param document <code>GiniCaptureDocument</code>
///
/// \param networkDelegate <code>GiniCaptureNetworkDelegate</code> used to tell the Gini Capture
/// Library to upload the pages upload state
///
- (void)didCaptureWithDocument:(id <GiniCaptureDocument> _Nonnull)document networkDelegate:(id <AnalysisDelegate, UploadDelegate> _Nonnull)networkDelegate;
/// Called when the user has taken a picture or imported a file (image or PDF) from camera roll or document explorer
/// \param document <code>GiniCaptureDocument</code>
///
- (void)didCaptureWithDocument:(id <GiniCaptureDocument> _Nonnull)document SWIFT_UNAVAILABLE_MSG("Use didCapture(document: GiniCaptureDocument, networkDelegate: GiniCaptureNetworkDelegate) instead");
/// Called when the user has taken an image.
/// \param imageData JPEG image data including meta information or PDF data
///
- (void)didCapture:(NSData * _Nonnull)imageData SWIFT_UNAVAILABLE_MSG("Use didCapture(document: GiniCaptureDocument, uploadDelegate: UploadDelegate) instead");
...
/// \param documents An array containing on or several reviewed <code>GiniCaptureDocument</code>
///
/// \param networkDelegate <code>GiniCaptureNetworkDelegate</code> used to tell the Gini Capture SDK that the documents
/// were reviewed and can be analyzed or uploaded.
///
- (void)didReviewWithDocuments:(NSArray<id <GiniCaptureDocument>> * _Nonnull)documents networkDelegate:(id <AnalysisDelegate, UploadDelegate> _Nonnull)networkDelegate;
...
///
- (void)didReviewWithDocument:(id <GiniCaptureDocument> _Nonnull)document withChanges:(BOOL)changes SWIFT_UNAVAILABLE_MSG("Use didReview(documents: [GiniCaptureDocument]) instead");
/// Called when the user has reviewed the image and potentially rotated it to the correct orientation.
/// \param imageData JPEG image data including eventually updated meta information or PDF Data
///
/// \param changes Indicates whether <code>imageData</code> was altered.
///
- (void)didReview:(NSData * _Nonnull)imageData withChanges:(BOOL)changes SWIFT_UNAVAILABLE_MSG("Use didReview(documents: [GiniCaptureDocument]) instead");
@optional
...
/// Called when the user navigates back from the review screen to the camera potentially to
/// retake an image. Should be used to cancel any ongoing analysis task on the image.
- (void)didCancelReview SWIFT_UNAVAILABLE_MSG("Use didCancelReview(for: GiniCaptureDocument) instead");
...
enum GiniCaptureDocumentType : NSInteger;

/// Document processed by the <em>GiniCapture</em> library.
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK19GiniCaptureDocument_")
@protocol GiniCaptureDocument
@property (nonatomic, readonly) enum GiniCaptureDocumentType type;
...
/// The <code>GiniCaptureDocumentBuilder</code> provides a way to build a <code>GiniCaptureDocument</code> from a <code>Data</code> object and
/// a <code>DocumentSource</code>. Additionally the <code>DocumentImportMethod</code> can bet set after builder iniatilization.
/// This is an example of how a <code>GiniCaptureDocument</code> should be built when it has been imported
...
///
/// \endcode
SWIFT_CLASS("_TtC14GiniCaptureSDK26GiniCaptureDocumentBuilder")
@interface GiniCaptureDocumentBuilder : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


typedef SWIFT_ENUM(NSInteger, GiniCaptureDocumentType, open) {
  GiniCaptureDocumentTypePdf = 0,
  GiniCaptureDocumentTypeImage = 1,
  GiniCaptureDocumentTypeQrcode = 2,
};
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14GiniCaptureSDK15GiniCaptureFont")
@interface GiniCaptureFont : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK26GiniCaptureResultsDelegate_")
@protocol GiniCaptureResultsDelegate
...
///
- (void)giniCaptureAnalysisDidFinishWithResult:(AnalysisResult * _Nonnull)result sendFeedbackBlock:(void (^ _Nonnull)(NSDictionary<NSString *, Extraction *> * _Nonnull))sendFeedbackBlock;
...
SWIFT_CLASS("_TtC14GiniCaptureSDK9GiniColor")
...
@protocol GiniLogger;
@class UIFont;
enum GiniCaptureImportFileTypes : NSInteger;
@class UIView;
@protocol PreferredButtonResource;

/// The <code>GiniConfiguration</code> class allows customizations to the look and feel of the Gini Capture SDK.
/// If there are limitations regarding which API can be used, this is clearly stated for the specific attribute.
/// note:
/// Text can also be set by using the appropriate keys in a <code>Localizable.strings</code> file in the projects bundle.
/// The library will prefer whatever value is set in the following order: attribute in configuration,
/// key in strings file in project bundle, key in strings file in <code>GiniCapture</code> bundle.
/// note:
/// Images can only be set by providing images with the same filename in an assets file or as individual files
/// in the projects bundle. The library will prefer whatever value is set in the following order: asset file
/// in project bundle, asset file in <code>GiniCapture</code> bundle.
/// attention:
/// If there are conflicting pairs of image and text for an interface element
/// (e.g. <code>navigationBarCameraTitleCloseButton</code>) the image will always be preferred,
/// while making sure the accessibility label is set.
SWIFT_CLASS("_TtC14GiniCaptureSDK17GiniConfiguration")
...
@property (nonatomic) BOOL giniErrorLoggerIsOn;
...
typedef SWIFT_ENUM(NSInteger, GiniCaptureImportFileTypes, open) {
  GiniCaptureImportFileTypesNone = 0,
  GiniCaptureImportFileTypesPdf = 1,
  GiniCaptureImportFileTypesPdf_and_images = 2,
};


SWIFT_CLASS("_TtC14GiniCaptureSDK17GiniImageDocument")
@interface GiniImageDocument : NSObject <GiniCaptureDocument>
@property (nonatomic) enum GiniCaptureDocumentType type;
...
@interface GiniImageDocument (SWIFT_EXTENSION(GiniCaptureSDK)) <NSItemProviderReading>
...
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK10GiniLogger_")
@protocol GiniLogger
/// Logs a message
...
SWIFT_CLASS("_TtC14GiniCaptureSDK24GiniScreenAPICoordinator")
@interface GiniScreenAPICoordinator : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC14GiniCaptureSDK34GiniNetworkingScreenAPICoordinator")
@interface GiniNetworkingScreenAPICoordinator : GiniScreenAPICoordinator
@end



@interface GiniNetworkingScreenAPICoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <GiniCaptureDelegate>
- (void)didCancelCapturing;
- (void)didCaptureWithDocument:(id <GiniCaptureDocument> _Nonnull)document networkDelegate:(id <AnalysisDelegate, UploadDelegate> _Nonnull)networkDelegate;
- (void)didReviewWithDocuments:(NSArray<id <GiniCaptureDocument>> * _Nonnull)documents networkDelegate:(id <AnalysisDelegate, UploadDelegate> _Nonnull)networkDelegate;
- (void)didCancelReviewFor:(id <GiniCaptureDocument> _Nonnull)document;
...
SWIFT_CLASS("_TtC14GiniCaptureSDK15GiniPDFDocument")
@interface GiniPDFDocument : NSObject <GiniCaptureDocument>
@property (nonatomic) enum GiniCaptureDocumentType type;
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSData * _Nonnull data;
@property (nonatomic, strong) UIImage * _Nullable previewImage;
...
@interface GiniPDFDocument (SWIFT_EXTENSION(GiniCaptureSDK)) <NSItemProviderReading>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<NSString *> * _Nonnull readableTypeIdentifiersForItemProvider;)
+ (NSArray<NSString *> * _Nonnull)readableTypeIdentifiersForItemProvider SWIFT_WARN_UNUSED_RESULT;
+ (nullable instancetype)objectWithItemProviderData:(NSData * _Nonnull)data typeIdentifier:(NSString * _Nonnull)typeIdentifier error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14GiniCaptureSDK18GiniQRCodeDocument")
@interface GiniQRCodeDocument : NSObject <GiniCaptureDocument>
@property (nonatomic) enum GiniCaptureDocumentType type;
@property (nonatomic, copy) NSData * _Nonnull data;
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, strong) UIImage * _Nullable previewImage;
...
@interface GiniQRCodeDocument (SWIFT_EXTENSION(GiniCaptureSDK))
...
@interface GiniScreenAPICoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <UINavigationControllerDelegate>
...
/// note:
/// Component API only.
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK28ReviewViewControllerDelegate_")
@protocol ReviewViewControllerDelegate
- (void)review:(ReviewViewController * _Nonnull)viewController didReview:(id <GiniCaptureDocument> _Nonnull)document;
@end


@interface GiniScreenAPICoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <ReviewViewControllerDelegate>
- (void)review:(ReviewViewController * _Nonnull)viewController didReview:(id <GiniCaptureDocument> _Nonnull)document;
@end


/// The UploadDelegate protocol defines methods that allow you to notify the <em>Gini Capture SDK</em> when a document upload
/// has finished (either successfully or with an error)
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK14UploadDelegate_")
@protocol UploadDelegate
- (void)uploadDidFailFor:(id <GiniCaptureDocument> _Nonnull)document with:(NSError * _Nonnull)error;
- (void)uploadDidCompleteFor:(id <GiniCaptureDocument> _Nonnull)document;
@end


@interface GiniScreenAPICoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <UploadDelegate>
- (void)uploadDidCompleteFor:(id <GiniCaptureDocument> _Nonnull)document;
- (void)uploadDidFailFor:(id <GiniCaptureDocument> _Nonnull)document with:(NSError * _Nonnull)error;
@end


@interface GiniScreenAPICoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <AnalysisDelegate>
- (void)displayErrorWithMessage:(NSString * _Nullable)message andAction:(void (^ _Nullable)(void))action;
- (BOOL)tryDisplayNoResultsScreen SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface GiniScreenAPICoordinator (SWIFT_EXTENSION(GiniCaptureSDK)) <CameraViewControllerDelegate>
- (void)camera:(CameraViewController * _Nonnull)viewController didCapture:(id <GiniCaptureDocument> _Nonnull)document;
- (void)camera:(CameraViewController * _Nonnull)viewController didSelect:(enum DocumentPickerType)documentPicker;
- (void)cameraDidAppear:(CameraViewController * _Nonnull)viewController;
- (void)cameraDidTapMultipageReviewButton:(CameraViewController * _Nonnull)viewController;
...
/// use the <em>Open with</em> feature and which formats are supported by the Gini Capture SDK.
SWIFT_CLASS("_TtC14GiniCaptureSDK22HelpMenuViewController")
...
@interface HelpMenuViewController (SWIFT_EXTENSION(GiniCaptureSDK))
...
SWIFT_CLASS("_TtC14GiniCaptureSDK36ImageAnalysisNoResultsViewController")
...
@interface ImageAnalysisNoResultsViewController (SWIFT_EXTENSION(GiniCaptureSDK)) <UICollectionViewDataSource>
...
@interface ImageAnalysisNoResultsViewController (SWIFT_EXTENSION(GiniCaptureSDK)) <UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC14GiniCaptureSDK29MultipageReviewViewController")
...
@interface MultipageReviewViewController (SWIFT_EXTENSION(GiniCaptureSDK)) <UICollectionViewDataSource>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (UICollectionReusableView * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView viewForSupplementaryElementOfKind:(NSString * _Nonnull)kind atIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
@interface MultipageReviewViewController (SWIFT_EXTENSION(GiniCaptureSDK)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
@interface MultipageReviewViewController (SWIFT_EXTENSION(GiniCaptureSDK))
- (void)loadView;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidAppear:(BOOL)animated;
...
typedef SWIFT_ENUM(NSInteger, NoticeActionType, open) {
...
SWIFT_CLASS("_TtC14GiniCaptureSDK14OnboardingPage")
...
/// \endcodenote:
/// Component API only.
SWIFT_CLASS("_TtC14GiniCaptureSDK24OnboardingViewController")
...
SWIFT_PROTOCOL("_TtP14GiniCaptureSDK23PreferredButtonResource_")
@protocol PreferredButtonResource
...
typedef SWIFT_ENUM(NSInteger, ReviewError, open) {
/// Unknown error during review.
  ReviewErrorUnknown = 0,
};
static NSString * _Nonnull const ReviewErrorDomain = @"GiniCaptureSDK.ReviewError";
...
/// note:
/// Component API only.
SWIFT_CLASS("_TtC14GiniCaptureSDK20ReviewViewController")
...
@interface ReviewViewController (SWIFT_EXTENSION(GiniCaptureSDK)) <UIScrollViewDelegate>
