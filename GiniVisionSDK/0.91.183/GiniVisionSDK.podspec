Pod::Spec.new do |s|
  ...
  s.preserve_paths = [ "GiniVisionFramework-#{s.version}/README.md", "GiniVisionFramework-#{s.version}/CHANGELOG.md" ]
  ...
  s.frameworks = 'AssetsLibrary', 'CoreMedia', 'CoreMotion', 'ImageIO', 'MobileCoreServices'
